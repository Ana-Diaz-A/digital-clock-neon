...
// creates and appends HTML elements to display a colon in a digital clock
const addColon = () => {
...
//  initializes a digital clock by creating and updating the digits for hours, minutes, and seconds. It also adds colons between the digits to represent the time format
const init = () => {
	let now = new Date();
